...
CMD_HELP.update(
    {
        "gdrive": "𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `.gdauth`"
        "\nPenggunaan: buat token untuk mengaktifkan semua layanan cmd google drive."
        "\\Ini hanya perlu dijalankan sekali seumur hidup."
        "\n\n𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `.gdreset`"
        "\nPenggunaan: setel ulang token Anda jika terjadi sesuatu yang buruk atau ubah drive acc."
        "\n\n𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `.gd`"
        "\nPenggunaan: Unggah file dari lokal atau uri/url/drivelink ke google drive."
        "\nfor drivelink, unggah hanya jika Anda mau."
        "\n\n𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `.gdabort`"
        "\nPenggunaan: Batalkan proses pengunggahan atau pengunduhan."
        "\n\n𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `.gdlist`"
        "\nPenggunaan: Dapatkan daftar folder dan file dengan ukuran default 50."
        "\nGunakan flag `-l range[1-1000]` untuk keluaran batas."
        "\nGunakan tanda `-p parent-folder_id` untuk daftar folder yang diberikan di gdrive."
        "\n\n𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `.gdf mkdir`"
        ...
        "\n\n𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `.gdfset put`"
        "\nPenggunaan: Ubah direktori unggah di gdrive."
        "\n\n𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `.gdfset rm`"
        "\nPenggunaan: hapus set parentId dari cmd\n𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `.gdfset put` "
        "ke **G_DRIVE_FOLDER_ID** dan jika unggahan kosong akan masuk ke root."
        "\n**NOTE:**"
        "\nfor `.gdlist` Anda dapat menggabungkan flag -l dan -p dengan atau tanpa nama "
        "pada saat yang sama, itu harus menjadi flag `-l` terlebih dahulu sebelum menggunakan flag `-p`.\n"
