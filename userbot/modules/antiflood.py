...
CMD_HELP.update(
    {
        "antiflood": "𝙋𝙡𝙪𝙜𝙞𝙣: `antiflood`\
        \n𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `.setflood` <jumlah pesan>\
        \nPenggunaan: Memperingatkan pengguna jika dia melakukan spam pada obrolan dan jika Anda adalah admin maka itu akan membisukan dia dalam grup itu.\
