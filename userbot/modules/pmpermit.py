...
DEF_UNAPPROVED_MSG = (
    "`𝐆𝐫𝐞𝐞𝐭𝐢𝐧𝐠𝐬 𝐅𝐫𝐢𝐞𝐧𝐝𝐬, 𝐰𝐡𝐚𝐭 𝐝𝐨 𝐲𝐨𝐮 𝐰𝐚𝐧𝐭 𝐟𝐨𝐫 {DEFAULTUSER}\n𝐈 𝐚𝐦 𝐚 𝐮𝐬𝐞𝐫𝐛𝐨𝐭 𝐭𝐨 𝐤𝐞𝐞𝐩 𝐭𝐡𝐞 𝐜𝐡𝐚𝐭 𝐫𝐨𝐨𝐦 𝐟𝐫𝐨𝐦 𝐬𝐩𝐚𝐦 𝐚𝐧𝐝 𝐬𝐜𝐚𝐦𝐬. 𝐏𝐥𝐞𝐚𝐬𝐞 𝐧𝐞𝐯𝐞𝐫 𝐝𝐨 𝐢𝐭!!\n\n`**𝙅𝙖𝙯𝙖𝙠𝙪𝙢𝙪𝙡𝙡𝙖𝙝 𝙆𝙝𝙖𝙞𝙧𝙖𝙣**\n\n"
    "`𝚊𝚞𝚝𝚘𝚖𝚊𝚝𝚒𝚌𝚊𝚕𝚕𝚢 𝚖𝚎𝚜𝚜𝚊𝚐𝚎` 𝙂𝘼𝙈𝙊𝙉 𝙐𝙎𝙀𝙍𝘽𝙊𝙏\n")
# =================================================================
...
async def disapprovepm(disapprvpm):
    ...
    await disapprvpm.edit(
        f"`❌ Sorry` [{name0}](tg://user?id={disapprvpm.chat_id}) `Your Message Has Been Rejected, You Are Automatically Blocked!`"
    )
