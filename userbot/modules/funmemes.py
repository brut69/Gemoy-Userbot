...
async def _(event):
    ...
    if input_str == "kill":
        ...
        animation_chars = [
            ...
            "------>;(^。^)ノ",
            "(￣ー￣) 𝗥𝗜𝗣",
            "**𝘛𝘢𝘳𝘨𝘦𝘵 𝘣𝘦𝘳𝘩𝘢𝘴𝘪𝘭 𝘥𝘪 𝘉𝘢𝘯𝘵𝘢𝘪 (°̥̥̥̥̥̥̥̥•̀.̫•́°̥̥̥̥̥̥̥)**",
        ]
...
async def _(event):
    ...
    if input_str == "hack":
        ...
        animation_chars = [
            "`Menghubungkan ke Server Pribadi yang Diretas...`",
            "`Target Dipilih.`",
            "`Hacking... 0%\n▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒ `",
            "`Hacking... 4%\n█▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒ `",
            "`Hacking... 8%\n██▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒ `",
            ...
            "`Hacking... 84%\n█████████████████████▒▒▒▒ `",
            "`Hacking... 100%\n█████████HACKED███████████ `",
            f"`Akun yang Ditargetkan Diretas...\n\nBayar 9999M Ke @{DEFAULTUSER} atau pesta miras Untuk Menghapus Peretasan Ini`",
        ]
...
async def _(event):
    ...
    if input_str == "whatsapp":
        ...
        animation_chars = [
            "Mencari database WhatsApp di target orang...",
...
async def _(event):
    ...
    if input_str == "quickheal":
        ...
        animation_chars = [
            ...
            "`Quick Heal Total Security Checkup\n\n\nLangganan: Pru User\nBerlaku Hingga: 31/12/2099\n\nFile Dipindai... 84%\n███████████████ `",
            "`Quick Heal Total Security Checkup\n\n\nLangganan: Pru User\nBerlaku Hingga: 31/12/2099\n\nFile Dipindai... 100%\n█████████████████████████ `",
            "`Quick Heal Total Security Checkup\n\n\nLangganan: Pru User\nBerlaku Hingga: 31/12/2099\n\nTugas: 01 dari 01 File Dipindai...\n\nHasil: Tidak Ada Virus Ditemukan...`",
        ]
...
async def _(event):
    ...
    if input_str == "fadmin":
        ...
        animation_chars = [
            "**Mempromosikan Pengguna Sebagai Admin...**",
            "**Mengaktifkan Semua Izin Kepada Pengguna...**",
            "**(1) Kirim pesan: ☑️**",
            "**(1) Kirim pesan: ✅**",
            "**(2) Kirim Media: ☑️**",
            "**(2) Kirim Media: ✅**",
            "**(3) Kirim Stiker & GIF: ☑️**",
            "**(3) Kirim Stiker & GIF: ✅**",
            "**(4) Kirim Polling: ☑️**",
            "**(4) Kirim Polling: ✅**",
            "**(5) Tautan Sematkan: ☑️**",
            "**(5) Tautan Sematkan: ✅**",
            "**(6) Tambahkan Pengguna: ☑️**",
            "**(6) Tambahkan Pengguna: ✅**",
            "**(7) Pin Pesan: ☑️**",
            "**(7) Pin Pesan: ✅**",
            "**(8) Ubah Info Obrolan: ☑️**",
            "**(8) Ubah Info Obrolan: ✅**",
            "**Izin Diberikan Berhasil**",
            "**SUKSES DIPROMOSIKAN SEBAGAI ADMIN**",
        ]
...
async def _(event):
    ...
    if input_str == "call":
        ...
        animation_chars = [
            "`Menghubungkan ke Kantor Pusat Telegram...`",
            "`Panggilan Tersambung.`",
            "`Telegram: Halo Ini adalah Telegram HQ. Siapa ini?`",
            f"`Saya: Yoi ini`@{DEFAULTUSER},`Tolong Hubungkan saya dengan adik saya, Pavel Durov`",
            "`Pengguna Diotorisasi.`",
            "`Memanggil Pavel Durov` `Pada +916969696969`",
            "`Panggilan Pribadi Tersambung...`",
            "`Saya: Halo Bruh, Tolong Ban Akun Telegram Ini.`",
            "`Pavel: Bolehkah Saya Tahu Siapa Ini?`",
            f"`Saya: Yoi Bruh, saya` @{DEFAULTUSER} ",
            "`Pavel: WTF!!! Lama tidak bertemu, Wassup Bruh...\nAku Akan Memastikan Akun Orang Itu Akan Diblokir Dalam 24 Jam.`",
            "`Saya : Terima kasih, sampai jumpa lagi bray.`",
            "`Pavel: Tolong Jangan Terima Brah, Telegram Milik Kami. Beri Saya Telepon Saat Anda Menjadi Gratis.`",
            "`Saya: Apakah Ada Masalah Darurat???`",
            "`Pavel: Ya Sur, Ada Bug Di Telegram v69.6.9.\nSaya Tidak Dapat Memperbaikinya. Jika Memungkinkan, Tolong Bantu Perbaiki Bug.`",
...
async def _(event):
    ...
    if input_str == "anim":
        ...
        animation_chars = [
            ...
            "😡",
            "😢",
            "__**...BOY oh BOY! aku merasa seperti wanita....**__",
        ]
...
async def _(event):
    ...
    if input_str == "wupload":
        ...
        animation_chars = [
            "Mengunggah File Dari Telegram Ke Whatsapp...",
            ...
            "UPLOAD FILE KE GRUP WHATSAPP SELESAI!\nFILE TERVERIFIKASI: ✅",
            "API DIHENTIKAN SAMPAI PENGGUNAAN LEBIH LANJUT...",
        ]
