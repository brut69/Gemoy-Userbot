...
CMD_HELP.update(
    {
        ...
        "\nPenggunaan: Membisukan ke semua grup yang kamu punya sebagai admin."
        "\n\n𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `.ungmute` <username/reply>"
        "\nPenggunaan: Reply someone's message with `.ungmute` to remove them from the gmuted list."
        "\n\n𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `.zombies`"
        "\nPenggunaan: Untuk mencari akun terhapus dalam grup."
        "Gunakan `.zombies clean` untuk menghapus Akun Terhapus dari grup."
        "\n\n𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `.all`"
        "\nPenggunaan: Tag semua member dalam grup."
        "\n\n𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `.admins`"
