...
async def _(event):
    ...
    await event.edit("**Mencuri identitas Akun ini...**")
    await updateProfile(userObj)
    await event.edit("**Anda sudah berhasil mengClone sebagai Akun ini 🥴**")
...
CMD_HELP.update(
    {
        ...
        \n  •  **Function : **Mulai Mengaktifkan Clonning Ke Seseorang.\
        \n\n  •  **Syntax :** `.rclone`\
        \n  •  **Function : **Mengembalikan ke identitas asli anda.\
        \n\n  •  **NOTE :** `.rclone` Mengembalikan Kloning, Dan Kembali Keakun Utama.\
    "
    }
)
