...
async def hack(event):
    ...
    await event.edit("`Memasang File Ke Server Pribadi yang Diretas...`")
    await asyncio.sleep(3)
    await event.edit("`Target Dipilih.`")
    await asyncio.sleep(4)
    await event.edit("`Menginstal... 0%\n▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒ `")
    await asyncio.sleep(3)
    await event.edit("`Menginstal... 4%\n█▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒ `")
    await asyncio.sleep(2)
    await event.edit("`Menginstal... 8%\n██▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒ `")
    await asyncio.sleep(3)
    await event.edit("`Menginstal... 20%\n█████▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒ `")
    await asyncio.sleep(2)
    await event.edit("`Menginstal... 36%\n█████████▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒ `")
    await asyncio.sleep(3)
    await event.edit("`Menginstal... 52%\n█████████████▒▒▒▒▒▒▒▒▒▒▒▒ `")
    await asyncio.sleep(2)
    ...
    await asyncio.sleep(3)
    await event.edit("Menghubungkan dan mendapatkan token gabungan dari my.telegram.org ")
    await asyncio.sleep(3)
