...
tg_sendinfo "<code>I am gonna merge staging into Gemoy-UserBot</code>"
cd
...
git push --force origin staging: Gemoy-UserBot
tg_sendinfo "<code>I have merged all commits from staging into Gemoy-UserBot</code>"
